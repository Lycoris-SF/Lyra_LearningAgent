...
public:
	...
	//Learning Agent PlayerStart
	UFUNCTION(BlueprintCallable, Category = "Lyra AI Player Controller")
	ALyraPlayerStart* GetLAPlayerStart() const { return LAPlayerStart.Get(); }
	UFUNCTION(BlueprintCallable, Category = "Lyra AI Player Controller")
	void SetLAPlayerStart(ALyraPlayerStart* NewPlayerStart);
...
private:
	...
	UPROPERTY()
	TObjectPtr<ALyraPlayerStart> LAPlayerStart;
};
